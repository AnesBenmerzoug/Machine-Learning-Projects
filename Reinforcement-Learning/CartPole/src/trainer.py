...
class AgentTrainer(object):
    ...
    def train_episode(self):
        ...
        for step_index in range(1, self.params.num_steps_per_episode+1):
            ...
            _, reward, done, info = self.env.step(action.data[0, 0])
            score += reward
            reward = score
    ...
    def optimize_model(self):
        ...
        next_state_values[non_final_mask] = self.target_network(non_final_next_states).gather(1, action_selection).detach()
    ...
    def load_model(self, useGPU=False):
        ...
        self.model = DQN.load_model(package, useGPU)
